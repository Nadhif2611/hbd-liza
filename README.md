...
<body>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='ã‹¡'>
       <p id="kalimat">Aku Ada Sesuatu Nih ðŸ¤£â¤ï¸</p>
       ...
       <!-- Pesan -->
       <p id="pesan3">Ciee.. Ada yang Ultah Nih ðŸ¤£â¤ï¸</p>
       <p id="pesan4">Happy Birthday, </p>
       <p id="pesan5" class="gaya2">Bagus banget ultahnya pas puasa</p>
       <p id="pesan6" class="gaya2">Moga panjang umur ya,ntar habis lebaran jangan lupa traktir traktir hehe.... ðŸ˜†â¤ï¸</p>
     ...
     <!-- Pesan Tambahan -->
     <p id="katatambahan" class="sembunyi">Gajadi deh soalnya belum ada kadonya hehe ðŸ˜œ</p>
     
     <!-- Pesan Ditolak -->
     <div id="pesanditolak">
       <img id="stikerditolak" src="https://feeldreams.github.io/weee.gif"/>
       <p id="kataditolak">Yaudah kalo gamau mh ðŸ˜œ</p>
     </div>
